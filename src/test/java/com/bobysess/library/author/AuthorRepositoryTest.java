...
class AuthorRepositoryTest {
  ...
  void findByName_matchesByLastname() {
    List<Author> results = authorRepository.findByName("hug");
  ...
  void findByName_matchesByFirstname() {
    List<Author> results = authorRepository.findByName("vict");
  ...
  void findByName_returnsEmpty_whenNoMatch() {
    List<Author> results = authorRepository.findByName("xyz");
